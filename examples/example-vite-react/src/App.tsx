      ...
      <div {...stylex.props(styles.inner)}>
        ...
        <div {...stylex.props(styles.card)}>
          <p {...stylex.props(styles.motionCue)}>
            Local review video smoke 2: hover, click, and watch the pulse ring.
          </p>
...
const styles = stylex.create({
  ...
  card: {
    ...
    outlineWidth: 2,
    outlineStyle: 'solid',
    outlineColor: { ':hover': 'rgba(100, 108, 255, 0.45)' },
    outlineOffset: { ':hover': 6 },
    transitionProperty: 'transform, box-shadow, outline-offset',
    transitionDuration: '250ms',
    transform: { ':hover': 'translateY(-4px)' },
    boxShadow: { ':hover': '0 16px 40px rgba(100, 108, 255, 0.22)' },
  },
  motionCue: {
    color: '#6b7280',
    fontSize: 14,
