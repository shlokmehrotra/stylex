...
export const vars = stylex.defineVars({
  ...
  '--color-fd-background': lightDark('hsl(32, 60%, 98%)', 'hsl(248, 28%, 8%)'),
  '--color-fd-foreground': lightDark('hsl(258, 26%, 12%)', 'hsl(40, 38%, 94%)'),
  '--color-fd-muted': lightDark('hsl(24, 42%, 94.5%)', 'hsl(246, 20%, 14%)'),
  '--color-fd-muted-foreground': lightDark(
    'hsl(258, 12%, 42%)',
    'hsla(35, 30%, 78%, 0.78)',
  ),
  '--color-fd-popover': lightDark('hsl(28, 48%, 98%)', 'hsl(247, 24%, 11.6%)'),
  '--color-fd-popover-foreground': lightDark(
    'hsl(258, 26%, 16%)',
    'hsl(34, 36%, 88%)',
  ),
  '--color-fd-card': lightDark('hsl(34, 56%, 99%)', 'hsl(247, 26%, 10%)'),
  ...
  '--color-fd-primary': lightDark('hsl(331, 80%, 58%)', 'hsl(322, 92%, 72%)'),
  '--color-fd-primary-foreground': lightDark(
    'hsl(32, 100%, 99%)',
    'hsl(252, 24%, 12%)',
  ),
  '--color-fd-secondary': lightDark('hsl(28, 42%, 92%)', 'hsl(248, 18%, 16%)'),
  '--color-fd-secondary-foreground': lightDark(
    'hsl(258, 24%, 18%)',
    'hsl(32, 28%, 84%)',
  ),
  '--color-fd-accent': lightDark('hsl(196, 55%, 88%)', 'hsl(205, 42%, 23%)'),
  '--color-fd-accent-foreground': lightDark(
    'hsl(198, 82%, 40%)',
    'hsl(191, 100%, 78%)',
  ),
  '--color-fd-ring': lightDark('hsl(43, 95%, 66%)', 'hsl(43, 100%, 72%)'),
