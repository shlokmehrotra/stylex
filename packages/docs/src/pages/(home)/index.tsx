...
const styles = stylex.create({
  ...
  glowPink: {
    ...
    width: 220,
    height: 220,
    background: `radial-gradient(circle, color-mix(in srgb, ${vars['--color-fd-primary']} 38%, white) 0%, transparent 72%)`,
  },
  glowBlue: {
    right: '14%',
    bottom: 40,
    width: 260,
    height: 260,
    background: `radial-gradient(circle, color-mix(in srgb, ${vars['--color-fd-accent-foreground']} 34%, white) 0%, transparent 74%)`,
  },
  gridTint: {
    position: 'absolute',
    inset: 0,
